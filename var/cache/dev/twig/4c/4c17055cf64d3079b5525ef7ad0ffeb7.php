...
class __TwigTemplate_fa77299a86d5b96db6739628155abb8a extends Template
{
    private $source;
    private $macros = [];
        ...
        echo "
                    ...
                    <div class=\"form-group\">
                        <label for=\"exampleInputLastName1\">
                            ";
        // line 22
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["registrationForm"]) || array_key_exists("registrationForm", $context) ? $context["registrationForm"] : (function () { throw new RuntimeError('Variable "registrationForm" does not exist.', 22, $this->source); })()), "lastName", [], "any", false, false, false, 22), 'row');
        echo "
                        </div>
                    </label>
                    <div class=\"form-group\">
...
";
    ...
    {
        return array (  156 => 44,  147 => 38,  141 => 34,  139 => 32,  131 => 27,  123 => 22,  115 => 17,  108 => 13,  102 => 9,  93 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "registration/register.html.twig", "/Users/remigarguilo13/blog-symfony/templates/registration/register.html.twig");
    }
}
